...
<html lang="en">
        ...
        <div class="welcome-slides owl-carousel">
            ...
            <div class="single-welcome-slide">
                ...
                <div class="background-curve">
                    <img src="theme/img/core-img/curve-1.png" alt="">
                </div>
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="welcome-text">
                                    <h2 data-animation="fadeInUp" data-delay="100ms">FIVEL <br>  <span>grab your life.</span></h2>
                                    <h5 data-animation="fadeInUp" data-delay="400ms">FIVEL devices are the most advanced, effective and user-friendly technological combination to pursue hand and upper limb rehabilitation. At the service of patients, doctors, therapists.</h5>
                                    <a href="{{route('portfolio')}}" class="btn uza-btn btn-2" data-animation="fadeInUp" data-delay="700ms">Start Exploring</a>
                                </div>
                            </div>
                            <!-- Welcome Thumbnail -->
                            <div class="col-12 col-md-6">
                                <div class="welcome-thumbnail">
                                    <img src="theme/img/bg-img/a.png" alt="" data-animation="slideInRight" data-delay="400ms">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="welcome-text">
                                    <h2 data-animation="fadeInUp" data-delay="100ms">FIVEL<br>
                                        <span>grab your life.</span></h2>
                                    <h5 data-animation="fadeInUp" data-delay="400ms">FIVEL devices are the most advanced, effective and user-friendly technological combination to pursue hand and upper limb rehabilitation. At the service of patients, doctors, therapists.</h5>
                                    <a href="{{route('portfolio')}}" class="btn uza-btn btn-2" data-animation="fadeInUp" data-delay="700ms">Start Exploring</a>
                                </div>
                            </div>
    ...
    <section class="uza-portfolio-area section-padding-80">
        ...
        <div class="portfolio-bg-curve">
            <img src="theme/img/core-img/curve-3.png" alt="">
        </div>
    </section>
    <!-- ***** Portfolio Area End ***** -->
    ...
    <section class="uza-blog-area">
        ...
        <div class="blog-bg-curve">
            <img src="theme/img/core-img/curve-4.png" alt="">
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- Single Blog Post -->
                <div class="col-12 col-lg-4">
                    <div class="single-blog-post bg-img mb-80" style="background-image: url(theme/img/bg-img/8.jpg);">
                        <!-- Post Content -->
                ...
                <!-- Single Blog Post -->
                <div class="col-12 col-lg-4">
                    <div class="single-blog-post bg-img mb-80" style="background-image: url(theme/img/bg-img/9.jpg);">
                        <!-- Post Content -->
                        <div class="post-content">
                ...
                <!-- Single Blog Post -->
                <div class="col-12 col-lg-4">
                    <div class="single-blog-post bg-img mb-80" style="background-image: url(theme/img/bg-img/10.jpg);">
                        <!-- Post Content -->
                        <div class="post-content">
