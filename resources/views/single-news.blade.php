                                    ...
                                    <div class="related-news-area">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                <div class="single-blog-post bg-img mb-50" style="background-image: url(theme/img/bg-img/8.jpg);">
                                                    <!-- Post Content -->
                                        ...
                                        <ol>
                                            ...
                                            <li class="single_comment_area">
                                                ...
                                                <div class="comment-content d-flex">
                                                    ...
                                                    <div class="comment-author">
                                                        <img src="theme/img/bg-img/15.jpg" alt="author">
                                                    </div>
                                                    <!-- Comment Meta -->
                                                ...
                                                <ol class="children">
                                                    <li class="single_comment_area">
                                                        ...
                                                        <div class="comment-content d-flex">
                                                            <!-- Comment Author -->
                                                            <div class="comment-author">
                                                                <img src="theme/img/bg-img/16.jpg" alt="author">
                                                            </div>
                                                            <!-- Comment Meta -->
                                                            <div class="comment-meta">
                                                                <a href="#" class="post-date">27 Aug 2018</a>
                                            ...
                                            <li class="single_comment_area">
                                                ...
                                                <div class="comment-content d-flex">
                                                    <!-- Comment Author -->
                                                    <div class="comment-author">
                                                        <img src="theme/img/bg-img/17.jpg" alt="author">
                                                    </div>
                                                    <!-- Comment Meta -->
                                                    <div class="comment-meta">
                                                        <a href="#" class="post-date">27 Aug 2018</a>
